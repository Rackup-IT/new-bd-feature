...
import { getAuthorsAction, logInAuthorAction } from '@/features/admin-panel/actions/author_action';
...
export async function GET(request: NextRequest) {
  ...
  // Handle fetching authors if no email/password provided
    ...
    try {
      ...
      const authors = await getAuthorsAction(status ? { approvalStatus: status } : undefined);
