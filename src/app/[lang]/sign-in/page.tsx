...
import SignInClient from "@/features/auth/sign-in/sign_in_client";
...
const SignInPage = async ({
  ...
  // Rendered on server; we'll leave the form markup but handle client behaviour in a small client component
  return (
    <>
      <div id="outer" className="mt-12 wrapper mx-auto mb-14">
        <div className="wrapper max-w-6xl mx-auto px-4">
          ...
          <section className="tc-authentication tc-sign-up">
            <div className="sm:flex sm:flex-row-reverse">
              ...
              {/* Menual SignIn Option  */}
              <SignInClient dict={dict} />
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-16 gap-6 mt-8">
              <aside className="note-of-intent lg:col-span-16 p-4 bg-gray-50 rounded-md">
                <p className="text-sm">
                  {dict["sign-up"]["We welcome debate..."]}
                  <Link
                    href="/community-standards"
                    className="text-blue-600 underline"
                  >
                    {dict["sign-up"]["Read our community standards"]}
                  </Link>
                </p>
              </aside>
            </div>
